...
<body>
    ...
    const booksData = [
        ...
        },
        {
            ...
            likes: 345,
            liked: false,
            authorBio: "د. فهد العامري، خبير اقتصادي سعودي، متخصص في تبسيط المفاهيم الاقتصادية.",
            description: "كتاب يقدم مفاهيم الاقتصاد الأساسية بطريقة مبسطة تناسب غير المتخصصين."
        }
    ];
